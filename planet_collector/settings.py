"""
Django settings for planet_collector project.
...
SECRET_KEY = 'django-insecure-0g98xuyn-@g-i8&7vrkpaq1wzb-^cdi^t(wais4w(w+i2c#doh'
...
ROOT_URLCONF = 'planet_collector.urls'
...
WSGI_APPLICATION = 'planet_collector.wsgi.application'
